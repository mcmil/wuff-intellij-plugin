...
public class DiagnosticPanel implements ApplicationComponent
{
    ...
    public DiagnosticPanel( Application application )
    {
        ...
        EditorTextField diagArea = new EditorTextField();
        diagArea.setEnabled( false );
         diagArea.setPreferredSize( new Dimension( 100, 200 ) );
        ...
        application.getMessageBus().connect()
            ...
            {
                @Override
                public void diagnosisSuccessful( java.util.List< BundleDiagnosis > bundles, String diag )
                {
