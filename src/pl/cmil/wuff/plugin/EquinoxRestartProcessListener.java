...
/**
 * If the process started for equinox returns with a specific exit code (defined by Equinox) restarts the run config.
 */
class EquinoxRestartProcessListener extends ProcessAdapter {
    ...
    public EquinoxRestartProcessListener(Module appModule, ExecutionEnvironment environment, Executor executor) {
